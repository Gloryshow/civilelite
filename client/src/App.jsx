      ...
      try {
        if (initialData) {
          ...
          setForm((current) => ({
            ...
            paramilitaryRank: applicant.paramilitaryRank || claim.paramilitaryRank || current.paramilitaryRank,
            paramilitaryPost: applicant.paramilitaryPost || claim.paramilitaryPost || current.paramilitaryPost,
        ...
        if (profile) {
          setForm((current) => ({
            ...
            paramilitaryRank: profile.paramilitaryRank || current.paramilitaryRank,
            paramilitaryPost: profile.paramilitaryPost || current.paramilitaryPost,
  ...
  const submitUpdate = async () => {
    ...
    try {
      await applicantAPI.submitApplication({
        ...
        paramilitaryRank: form.paramilitaryRank,
        paramilitaryPost: form.paramilitaryPost,
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: 20, alignItems: "start" }}>
              <div>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(230px, 1fr))", gap: 14 }}>
                  ...
                  <LegacyField label="Assigned Rank" value={form.paramilitaryRank} onChange={(event) => setForm((current) => ({ ...current, paramilitaryRank: event.target.value }))} placeholder="e.g. Recruit / Lance Corporal" />
                  <LegacyField label="Assigned Post" value={form.paramilitaryPost} onChange={(event) => setForm((current) => ({ ...current, paramilitaryPost: event.target.value }))} placeholder="e.g. Operations / Training Unit" />
                </div>
